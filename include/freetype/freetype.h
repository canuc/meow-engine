...
#define ft_encoding_apple_roman     FT_ENCODING_APPLE_ROMAN
  ...
  /*                                                                       */
  /*    units_per_EM        :: The number of font units per EM SQUARE_COORDS_LOCATION for  */
...
#define FT_STYLE_FLAG_BOLD    ( 1 << 1 )
  ...
  /*                                                                       */
  /* <Fields>                                                              */
  /*    x_ppem       :: The width of the scaled EM SQUARE_COORDS_LOCATION in pixels, hence */
  /*                    the term `ppem' (pixels per EM).  It is also       */
  /*                    referred to as `nominal width'.                    */
  /*                                                                       */
  /*    y_ppem       :: The height of the scaled EM SQUARE_COORDS_LOCATION in pixels,      */
