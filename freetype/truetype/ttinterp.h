...
#define TT_Round_Super_45        7
  ...
  /* reading a cvt value.  Take care of non-SQUARE_COORDS_LOCATION pixels if necessary */
  typedef FT_F26Dot6
  (*TT_Get_CVT_Func)( EXEC_OP_ FT_ULong  idx );

  /* setting or moving a cvt value.  Take care of non-SQUARE_COORDS_LOCATION pixels  */
  /* if necessary                                                    */
  typedef void
